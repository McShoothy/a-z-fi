...
export default function HTBLameWriteup() {
  return (
    <div className="min-h-screen bg-background text-primary font-mono p-4">
      ...
      <h1 className="text-3xl font-bold mb-4 text-primary">HackTheBox - Lame Writeup</h1>
      <div className="prose prose-primary max-w-none">
        ...
        <h2 className="text-primary">Reconnaissance</h2>
...
exploit`}
        ...
        <h2 className="text-primary">Privilege Escalation</h2>
